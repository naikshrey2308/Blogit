...
namespace BlogIt.Models
{
    public class SQLBlogRepository : IBlogRepository
    {
        ...
        IEnumerable<Blog> IBlogRepository.GetAllBlogs()
        {
            ...
            return context.Blogs.Include(b => b.Author).Include(b => b.category);
        }

        Blog IBlogRepository.GetBlog(int Id)
        {
            return context.Blogs.Include(b => b.Author).Include(b => b.category).Include(b => b.Comments).ThenInclude(c => c.user).FirstOrDefault(b => b.Id == Id);
        }
